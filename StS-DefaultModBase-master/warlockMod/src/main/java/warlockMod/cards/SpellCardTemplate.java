...
public class SpellCardTemplate extends AbstractDynamicCard {
    ...
    public static final String ID = WarlockMod.makeID("DefaultCommonAttack"); // DELETE THIS ONE.
    public static final String IMG = WarlockMod.makeCardPath("Attack.png");// "public static final String IMG = makeCardPath("${NAME}.png");
    ...
    public SpellCardTemplate() { // public ${NAME}() - This one and the one right under the imports are the most important ones, don't forget them
